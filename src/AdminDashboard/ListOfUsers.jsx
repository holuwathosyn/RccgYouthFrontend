...
const YouthRegistrationAdmin = () => {
  ...
  const exportToExcel = () => {
    const worksheet =
      XLSX.utils.json_to_sheet(filteredMembers);
    ...
    saveAs(
      fileData,
      `RCCG_Youth_Registration_${Date.now()}.xlsx`
    );
  };
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Youth Registration Dashboard
              </h1>
              <p className="text-gray-500 mt-1">
                Manage registered church youths
              </p>
            </div>
          ...
          <>
            ...
            <div className="md:hidden space-y-4">
              {filteredMembers.map((member) => (
                <div
                  key={member._id}
                  className="bg-white p-5 rounded-3xl shadow-sm flex justify-between items-center"
                >
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {member.occupation} • {member.gender}
                    </p>
